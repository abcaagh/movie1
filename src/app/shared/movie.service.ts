	...
	public moviesList: Movie[] = [
		{
			...
			genres: [MovieGenre.action, MovieGenre.adventure, MovieGenre.comedy],
			rate: '8.6',
			length: '1hr 48mins',
			img: 'deadpool.jpg',
		},
		{
			...
			genres: [MovieGenre.adventure, MovieGenre.comedy, MovieGenre.crime],
			rate: '7.0',
			length: '1hr 50mins',
		...
		},
		{
			...
			genres: [MovieGenre.biography, MovieGenre.drama, MovieGenre.history],
			rate: '8.0',
			length: '2hr 27mins',
		...
		},
		{
			...
			genres: [MovieGenre.crime, MovieGenre.drama, MovieGenre.sport],
			rate: '6.9',
			length: '2hr 5mins',
		...
		},
		{
			...
			genres: [MovieGenre.biography, MovieGenre.crime, MovieGenre.drama],
			rate: '7.8',
			length: '2hr 37mins',
		...
		},
		{
			...
			genres: [MovieGenre.crime, MovieGenre.mystery, MovieGenre.thriller],
			rate: '7.3',
			length: '1hr 55mins',
		...
		},
		{
			...
			genres: [MovieGenre.action, MovieGenre.adventure, MovieGenre.scifi],
			rate: '7.1',
			length: '2hr 4mins',
		...
		},
		{
			...
			genres: [MovieGenre.action, MovieGenre.adventure, MovieGenre.thriller],
			rate: '7.5',
			length: '2hr 11mins',
		...
		},
		{
			...
			genres: [MovieGenre.action, MovieGenre.drama, MovieGenre.sport],
			rate: '7.5',
			length: '2hr 4mins',
			img: 'southpaw.jpg',
		},
		{
			...
			genres: [MovieGenre.biography, MovieGenre.drama, MovieGenre.thriller],
			rate: '7.7',
			length: '2hr 22mins',
		...
		},
		{
			...
			genres: [MovieGenre.action, MovieGenre.scifi],
			rate: '8.7',
			length: '2hr 16mins',
			img: 'the-matrix.jpg',
		},
